...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-121204875-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-121204875-1');
</script>
    ...
    <meta name="keywords" content="live,news,portal,trending,livenewsportal">
    ...
    <meta name="google-site-verification" content="TrBu8wOCq3nFvbnBRVBg7JuPzVJjcYfNSDt2ParZeBU" />
...
<?php include 'navbar.php';?>
    ...
    <?php include 'sidebar.php';?>
        ...
        <div id="content" class="container">
            <center><h1 style="margin-top: 10px; margin-bottom: 15px; font-family: fira Sans; font-weight: 700;  font-style: normal;" id="pageHeading">Trending</h1></center>
              <div class="row">
                  <div id="trending_1">
        ...
        {*/
               ...
               document.getElementById("image"+1).src="<?php
                ...
                document.getElementById("brief"+1).innerHTML="<?php 
                    ...
                    $resultc=mysqli_query($db,$queryc);   
                    $rowc=mysqli_fetch_assoc($resultc);
                    $query="SELECT `Brief` FROM `trending` WHERE `ID`=".$rowc["COUNT(*)"];
                    $query=mysqli_real_escape_string($db,$query);
                    $result=mysqli_query($db,$query);   
                    $row=mysqli_fetch_assoc($result);
                    echo addslashes($row["Brief"]);?>";
               ...
               document.getElementById("image"+2).src="<?php
                ...
                document.getElementById("brief"+2).innerHTML="<?php 
                    ...
                    $resultc=mysqli_query($db,$queryc);   
                    $rowc=mysqli_fetch_assoc($resultc);
                    $query="SELECT `Brief` FROM `trending` WHERE `ID`=".($rowc["COUNT(*)"]-1);
                    $query=mysqli_real_escape_string($db,$query);
                    $result=mysqli_query($db,$query);
                    $row=mysqli_fetch_assoc($result);
                    echo addslashes($row["Brief"]);
               ...
               document.getElementById("image"+3).src="<?php
                ...
                document.getElementById("brief"+3).innerHTML="<?php 
                    ...
                    $resultc=mysqli_query($db,$queryc);   
                    $rowc=mysqli_fetch_assoc($resultc);
                    $query="SELECT `Brief` FROM `trending` WHERE `ID`=".($rowc["COUNT(*)"]-2);
                    $query=mysqli_real_escape_string($db,$query);
                    $result=mysqli_query($db,$query);
                    $row=mysqli_fetch_assoc($result);
                    echo addslashes($row["Brief"]);
               ...
               document.getElementById("image"+4).src="<?php
                ...
                document.getElementById("brief"+4).innerHTML="<?php 
                    ...
                    $resultc=mysqli_query($db,$queryc);   
                    $rowc=mysqli_fetch_assoc($resultc);
                    $query="SELECT `Brief` FROM `trending` WHERE `ID`=".($rowc["COUNT(*)"]-3);
                    $query=mysqli_real_escape_string($db,$query);
                    $result=mysqli_query($db,$query);
                    $row=mysqli_fetch_assoc($result);
                    echo addslashes($row["Brief"]);
               ...
               document.getElementById("image"+5).src="<?php
                ...
                document.getElementById("brief"+5).innerHTML="<?php 
                    ...
                    $resultc=mysqli_query($db,$queryc);   
                    $rowc=mysqli_fetch_assoc($resultc);
                    $query="SELECT `Brief` FROM `trending` WHERE `ID`=".($rowc["COUNT(*)"]-4);
                    $query=mysqli_real_escape_string($db,$query);
                    $result=mysqli_query($db,$query);
                    $row=mysqli_fetch_assoc($result);
                    echo addslashes($row["Brief"]);
               ...
               document.getElementById("image"+6).src="<?php
                ...
                document.getElementById("brief"+6).innerHTML="<?php 
                    ...
                    $resultc=mysqli_query($db,$queryc);   
                    $rowc=mysqli_fetch_assoc($resultc);
                    $query="SELECT `Brief` FROM `trending` WHERE `ID`=".($rowc["COUNT(*)"]-5);
                    $query=mysqli_real_escape_string($db,$query);
                    $result=mysqli_query($db,$query);
                    $row=mysqli_fetch_assoc($result);
                    echo addslashes($row["Brief"]);
