...
<head>
    ...
    <meta name="keywords" content="live,news,portal,trending,politics,entertainment,livenewsportal">
  ...
  (function() {
    ...
    <div class="container-fluid">
        ...
        <div id="content" class="container">
            <center><h1 style="margin-top: 10px; margin-bottom: 15px; font-family: fira Sans; font-weight: 700;  font-style: normal;" id="pageHeading">Entertainment</h1></center>
              <div class="row">
                  <div id="entertainment_1">
...
<!-- Facebook -->
    ...
    <script>
      /*  for(i=1;i<=<?php  $db = mysqli_connect('localhost', 'livenews_portal', 'creatives@2k18', 'livenews_news');
                    $query="SELECT COUNT(*) FROM entertainment";
        ...
        {*/
                document.getElementById("heading"+1).innerHTML="<?php
                    ...
                    $queryc="SELECT COUNT(*) FROM entertainment";
                    $queryc=mysqli_real_escape_string($db,$queryc);
                    $resultc=mysqli_query($db,$queryc);   
                    $rowc=mysqli_fetch_assoc($resultc);
                    $query="SELECT `Title` FROM `entertainment` WHERE `ID`=".$rowc["COUNT(*)"];
                    $query=mysqli_real_escape_string($db,$query);
                    $result=mysqli_query($db,$query);   
                    $row=mysqli_fetch_assoc($result);
                    echo $row["Title"];?>";
               document.getElementById("image"+1).src="<?php
                    ...
                    $resultc=mysqli_query($db,$queryc);   
                    $rowc=mysqli_fetch_assoc($resultc);
                    $query="SELECT `Image` FROM `entertainment` WHERE `ID`=".$rowc["COUNT(*)"];
                    $query=mysqli_real_escape_string($db,$query);
                    $result=mysqli_query($db,$query);   
                    $row=mysqli_fetch_assoc($result);
                    echo $row["Image"];?>";
                document.getElementById("brief"+1).innerHTML="<?php 
                    ...
                    $resultc=mysqli_query($db,$queryc);   
                    $rowc=mysqli_fetch_assoc($resultc);
                    $query="SELECT `Brief` FROM `entertainment` WHERE `ID`=".$rowc["COUNT(*)"];
                    $query=mysqli_real_escape_string($db,$query);
                    $result=mysqli_query($db,$query);   
                    $row=mysqli_fetch_assoc($result);
                    echo $row["Brief"];?>";
                document.getElementById("date"+1).innerHTML="<?php 
                    ...
                    $resultc=mysqli_query($db,$queryc);   
                    $rowc=mysqli_fetch_assoc($resultc);
                    $query="SELECT `Date` FROM `entertainment` WHERE `ID`=".$rowc["COUNT(*)"];
                    $query=mysqli_real_escape_string($db,$query);
                    $result=mysqli_query($db,$query);
                    $row=mysqli_fetch_assoc($result);
                    echo $row["Date"];            
                ...
                document.getElementById("heading"+2).innerHTML="<?php
                    ...
                    $resultc=mysqli_query($db,$queryc);   
                    $rowc=mysqli_fetch_assoc($resultc);
                    $query="SELECT `Title` FROM `entertainment` WHERE `ID`=".($rowc["COUNT(*)"]-1);
                    $query=mysqli_real_escape_string($db,$query);
                    $result=mysqli_query($db,$query);   
                    $row=mysqli_fetch_assoc($result);
                    echo $row["Title"];?>";
               document.getElementById("image"+2).src="<?php
                    ...
                    $resultc=mysqli_query($db,$queryc);   
                    $rowc=mysqli_fetch_assoc($resultc);
                    $query="SELECT `Image` FROM `entertainment` WHERE `ID`=".($rowc["COUNT(*)"]-1);
                    $query=mysqli_real_escape_string($db,$query);
                    $result=mysqli_query($db,$query);   
                    $row=mysqli_fetch_assoc($result);
                    echo $row["Image"];?>";
                document.getElementById("brief"+2).innerHTML="<?php 
                    ...
                    $resultc=mysqli_query($db,$queryc);   
                    $rowc=mysqli_fetch_assoc($resultc);
                    $query="SELECT `Brief` FROM `entertainment` WHERE `ID`=".($rowc["COUNT(*)"]-1);
                    $query=mysqli_real_escape_string($db,$query);
                    $result=mysqli_query($db,$query);
                    $row=mysqli_fetch_assoc($result);
                    echo $row["Brief"];
                ...
                document.getElementById("date"+2).innerHTML="<?php 
                    ...
                    $resultc=mysqli_query($db,$queryc);   
                    $rowc=mysqli_fetch_assoc($resultc);
                    $query="SELECT `Date` FROM `entertainment` WHERE `ID`=".($rowc["COUNT(*)"]-1);
                    $query=mysqli_real_escape_string($db,$query);
                    $result=mysqli_query($db,$query);
                    $row=mysqli_fetch_assoc($result);
                    echo $row["Date"];            
                    ...
                    $resultc=mysqli_query($db,$queryc);   
                    $rowc=mysqli_fetch_assoc($resultc);
                    $query="SELECT `Title` FROM `entertainment` WHERE `ID`=".($rowc["COUNT(*)"]-2);
                    $query=mysqli_real_escape_string($db,$query);
                    $result=mysqli_query($db,$query);   
                    $row=mysqli_fetch_assoc($result);
                    echo $row["Title"];?>";
               document.getElementById("image"+3).src="<?php
                    ...
                    $resultc=mysqli_query($db,$queryc);   
                    $rowc=mysqli_fetch_assoc($resultc);
                    $query="SELECT `Image` FROM `entertainment` WHERE `ID`=".($rowc["COUNT(*)"]-2);
                    $query=mysqli_real_escape_string($db,$query);
                    $result=mysqli_query($db,$query);   
                    $row=mysqli_fetch_assoc($result);
                    echo $row["Image"];?>";
                document.getElementById("brief"+3).innerHTML="<?php 
                    ...
                    $resultc=mysqli_query($db,$queryc);   
                    $rowc=mysqli_fetch_assoc($resultc);
                    $query="SELECT `Brief` FROM `entertainment` WHERE `ID`=".($rowc["COUNT(*)"]-2);
                    $query=mysqli_real_escape_string($db,$query);
                    $result=mysqli_query($db,$query);
                    $row=mysqli_fetch_assoc($result);
                    echo $row["Brief"];
                ...
                document.getElementById("date"+3).innerHTML="<?php 
                    ...
                    $resultc=mysqli_query($db,$queryc);   
                    $rowc=mysqli_fetch_assoc($resultc);
                    $query="SELECT `Date` FROM `entertainment` WHERE `ID`=".($rowc["COUNT(*)"]-2);
                    $query=mysqli_real_escape_string($db,$query);
                    $result=mysqli_query($db,$query);
                    $row=mysqli_fetch_assoc($result);
                    echo $row["Date"];            
                    ...
                    $resultc=mysqli_query($db,$queryc);   
                    $rowc=mysqli_fetch_assoc($resultc);
                    $query="SELECT `Title` FROM `entertainment` WHERE `ID`=".($rowc["COUNT(*)"]-3);
                    $query=mysqli_real_escape_string($db,$query);
                    $result=mysqli_query($db,$query);   
                    $row=mysqli_fetch_assoc($result);
                    echo $row["Title"];?>";
               document.getElementById("image"+4).src="<?php
                    ...
                    $resultc=mysqli_query($db,$queryc);   
                    $rowc=mysqli_fetch_assoc($resultc);
                    $query="SELECT `Image` FROM `entertainment` WHERE `ID`=".($rowc["COUNT(*)"]-3);
                    $query=mysqli_real_escape_string($db,$query);
                    $result=mysqli_query($db,$query);   
                    $row=mysqli_fetch_assoc($result);
                    echo $row["Image"];?>";
                document.getElementById("brief"+4).innerHTML="<?php 
                    ...
                    $resultc=mysqli_query($db,$queryc);   
                    $rowc=mysqli_fetch_assoc($resultc);
                    $query="SELECT `Brief` FROM `entertainment` WHERE `ID`=".($rowc["COUNT(*)"]-3);
                    $query=mysqli_real_escape_string($db,$query);
                    $result=mysqli_query($db,$query);
                    $row=mysqli_fetch_assoc($result);
                    echo $row["Brief"];
                ...
                document.getElementById("date"+4).innerHTML="<?php 
                    ...
                    $resultc=mysqli_query($db,$queryc);   
                    $rowc=mysqli_fetch_assoc($resultc);
                    $query="SELECT `Date` FROM `entertainment` WHERE `ID`=".($rowc["COUNT(*)"]-3);
                    $query=mysqli_real_escape_string($db,$query);
                    $result=mysqli_query($db,$query);
                    $row=mysqli_fetch_assoc($result);
                    echo $row["Date"];            
                    ...
                    $resultc=mysqli_query($db,$queryc);   
                    $rowc=mysqli_fetch_assoc($resultc);
                    $query="SELECT `Title` FROM `entertainment` WHERE `ID`=".($rowc["COUNT(*)"]-4);
                    $query=mysqli_real_escape_string($db,$query);
                    $result=mysqli_query($db,$query);   
                    $row=mysqli_fetch_assoc($result);
                    echo $row["Title"];?>";
               document.getElementById("image"+5).src="<?php
                    ...
                    $resultc=mysqli_query($db,$queryc);   
                    $rowc=mysqli_fetch_assoc($resultc);
                    $query="SELECT `Image` FROM `entertainment` WHERE `ID`=".($rowc["COUNT(*)"]-4);
                    $query=mysqli_real_escape_string($db,$query);
                    $result=mysqli_query($db,$query);   
                    $row=mysqli_fetch_assoc($result);
                    echo $row["Image"];?>";
                document.getElementById("brief"+5).innerHTML="<?php 
                    ...
                    $resultc=mysqli_query($db,$queryc);   
                    $rowc=mysqli_fetch_assoc($resultc);
                    $query="SELECT `Brief` FROM `entertainment` WHERE `ID`=".($rowc["COUNT(*)"]-4);
                    $query=mysqli_real_escape_string($db,$query);
                    $result=mysqli_query($db,$query);
                    $row=mysqli_fetch_assoc($result);
                    echo $row["Brief"];
                ...
                document.getElementById("date"+5).innerHTML="<?php 
                    ...
                    $resultc=mysqli_query($db,$queryc);   
                    $rowc=mysqli_fetch_assoc($resultc);
                    $query="SELECT `Date` FROM `entertainment` WHERE `ID`=".($rowc["COUNT(*)"]-4);
                    $query=mysqli_real_escape_string($db,$query);
                    $result=mysqli_query($db,$query);
                    $row=mysqli_fetch_assoc($result);
                    echo $row["Date"];            
                    ...
                    $resultc=mysqli_query($db,$queryc);   
                    $rowc=mysqli_fetch_assoc($resultc);
                    $query="SELECT `Title` FROM `entertainment` WHERE `ID`=".($rowc["COUNT(*)"]-5);
                    $query=mysqli_real_escape_string($db,$query);
                    $result=mysqli_query($db,$query);   
                    $row=mysqli_fetch_assoc($result);
                    echo $row["Title"];?>";
               document.getElementById("image"+6).src="<?php
                    ...
                    $resultc=mysqli_query($db,$queryc);   
                    $rowc=mysqli_fetch_assoc($resultc);
                    $query="SELECT `Image` FROM `entertainment` WHERE `ID`=".($rowc["COUNT(*)"]-5);
                    $query=mysqli_real_escape_string($db,$query);
                    $result=mysqli_query($db,$query);   
                    $row=mysqli_fetch_assoc($result);
                    echo $row["Image"];?>";
                document.getElementById("brief"+6).innerHTML="<?php 
                    ...
                    $resultc=mysqli_query($db,$queryc);   
                    $rowc=mysqli_fetch_assoc($resultc);
                    $query="SELECT `Brief` FROM `entertainment` WHERE `ID`=".($rowc["COUNT(*)"]-5);
                    $query=mysqli_real_escape_string($db,$query);
                    $result=mysqli_query($db,$query);
                    $row=mysqli_fetch_assoc($result);
                    echo $row["Brief"];
                ...
                document.getElementById("date"+6).innerHTML="<?php 
                    $db = mysqli_connect('localhost', 'livenews_portal', 'creatives@2k18', 'livenews_news');
                    $query="SELECT `Date` FROM `entertainment` WHERE `ID`=".($rowc["COUNT(*)"]-5);
                    $queryc=mysqli_real_escape_string($db,$queryc);
                    $resultc=mysqli_query($db,$queryc);   
                    $rowc=mysqli_fetch_assoc($resultc);
                    $query=mysqli_real_escape_string($db,$query);
